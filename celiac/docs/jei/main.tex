...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{kg_schema.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{kg_statistics.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{tsne_embeddings.png}
