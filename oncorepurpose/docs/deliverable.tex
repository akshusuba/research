...
\item \textbf{New, prospective:} on a time-split the GNN ranks future indications at AUROC 0.930 and surfaces $11\times$ as many in the top 50 as a structure-blind control (named post-2005 approvals included).
...
structure-blind control is competitive, which we report rather than hide.
...
with \texttt{clinicaltrials\_deconfounded.json} (the characterized negative). A six-part Colab notebook track
